...
public class DaoEmpleadoCliente {
    ...
    public String comboBoxEmpleadoCliente(String name,int id_empresa_cliente) throws SQLException{
        rs = con.execute("select id_empleado_cliente,nombre from empleado_cliente where id_empresa_cliente = "+ id_empresa_cliente);
    ...
    public ArrayList<EmpleadoCliente> listar() throws SQLException{
        ...
        rs = con.execute("select id_empleado_cliente,nombre,mail,id_empresa_cliente from id_empresa_cliente");
        while(rs.next()){ 
