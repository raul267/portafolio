 ...
 * @author 56942
 */
@WebServlet(name = "AgregarEmpleadoCarro", urlPatterns = {"/AgregarEmpleadoCarro"})
public class AgregarEmpleadoCarro extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        int id_empleado = Integer.parseInt(request.getParameter("txtId"));
        for (model_antiguo.EmpleadoCliente e : le) {
