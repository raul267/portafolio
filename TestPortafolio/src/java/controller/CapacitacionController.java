...
@WebServlet(name = "CapacitacionController", urlPatterns = {"/CapacitacionController"})
public class CapacitacionController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int enterreno = (request.getParameter("enterreno").equals("on"))? 1:0 ;
        
        Capacitacion capacitacion = new Capacitacion(id, nombre, descripcion, cantidad_asistentes, enterreno);
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<br><label><b> nombre: </b>" + nombre + "</label>");
            out.println("<br><label><b> descripcion: </b>" + descripcion + "</label>");
            out.println("<br><label><b> en terreno: </b>" + enterreno + "</label>");
            out.println("<br><label><b> cantidad asistentes: </b>" + cantidad_asistentes + "</label>");
            out.println("</body>");
            out.println("</html>");
        }
    }
