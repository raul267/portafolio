...
public class Servicio implements DAO {
    ...
    public int getCantidadAsesoria() {
        return cantidadAsesoria;
    }

    public void setCantidadAsesoria(int cantidadAsesoria) {
        this.cantidadAsesoria = cantidadAsesoria;
    }
    ...
    public int getCantidadCapacitacion() {
        return cantidadCapacitacion;
    }

    public void setCantidadCapacitacion(int cantidadCapacitacion) {
        this.cantidadCapacitacion = cantidadCapacitacion;
    }

    public int getCheckList_estado() {
        return checkList_estado;
    }

    public void setCheckList_estado(int checkList_estado) {
        this.checkList_estado = checkList_estado;
    }
    ...
    public String toString() {
        return "Servicio{" + "id=" + id + ", id_empresa_cliente=" + id_empresa_cliente + ", cantidadVisitas=" + cantidadVisitas + ", cantidadAsesoria=" + cantidadAsesoria + ", cantidadLlamadas=" + cantidadLlamadas + ", cantidadCapacitacion=" + cantidadCapacitacion + ", checkList_estado=" + checkList_estado + ", costoTotal=" + costoTotal + ", empresaCliente=" + empresaCliente + '}';
    }
